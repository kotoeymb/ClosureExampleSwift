 ...
 */
public protocol PopupContentVC {
...
//        NotificationCenter.default.addObserver(self, selector: #selector(PopupController.popupControllerWillShowKeyboard(_:)), name: NSNotification.Name.UIResponder.keyboardWillShowNotification, object: nil)
//        NotificationCenter.default.addObserver(self, selector: #selector(PopupController.popupControllerWillHideKeyboard(_:)), name: NSNotification.Name.UIResponder.keyboardWillHideNotification, object: nil)
//        NotificationCenter.default.addObserver(self, selector: #selector(PopupController.popupControllerDidHideKeyboard(_:)), name: NSNotification.Name.UIResponder.keyboardDidHideNotification, object: nil)
//    }
...
//
    ...
    func updateLayouts() {
        guard let child = self.children.last as? PopupContentVC else { return }
    ...
    func show(_ layout: PopupLayout, animation: PopupAnimation, completion: @escaping PopupAnimateCompletion) {
        guard let childViewController = children.last as? PopupContentVC else {
            return
        }
    ...
    func hide(_ animation: PopupAnimation, completion: @escaping PopupAnimateCompletion) {
        guard let child = children.last as? PopupContentVC else {
            return
        }
